...
namespace pal
{
    struct Encoder
    {
        static void encode(const std::string& path, const std::vector<Variable>& string, const std::vector<Production>& productions, Metadata metadata);
        ...
        static void encodeProductions(Bitwriter& writer, const huffman::Encoder& encoder, const std::vector<Production>& productions, Metadata metadata);
